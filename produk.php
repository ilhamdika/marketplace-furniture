<section id="highlights" class="highlights scrollspy">
	<div class="container" style="margin-top:80px;">
		<h2 class="center-align">Produk Terbaru</h2>
		<a href="katalog.php" type="button" class="btn btn-primary" style="border-radius:50px; margin-bottom: 10px;">Semua produk</a>
		<div class="row">
						...
						<div class="card-image waves-effect waves-block waves-light">
							<center>
								<a href="detail.php?id=<?php echo $perproduk['id_produk']; ?>">
									<p style="color:black;"><strong style="color:black; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;"><a href="detail.php?id=<?php echo $perproduk['id_produk'] ?>" style="color:black;"><?php echo $perproduk['nama_produk']; ?></strong></p>
								</a>
								<a href="detail.php?id=<?php echo $perproduk['id_produk']; ?>">
