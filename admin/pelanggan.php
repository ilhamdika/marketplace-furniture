        ...
        LIMIT " . $limitStart . "," . $limit);
			...
			?>
				<tr>
					...
					<td>
						<a href="index.php?halaman=detailpelanggan&id=<?php echo $row['id_pelanggan']; ?>" class="btn cyan waves-effect waves-light" style="border-radius: 50px;">detail</a>
						<a href="index.php?halaman=hapuspelanggan&id=<?php echo $row['id_pelanggan']; ?>" class="btn red waves-effect waves-light" style="border-radius: 50px;">hapus</a>
					</td>
				</tr>
				<?php $nomor++; ?>
			<?php } ?>
