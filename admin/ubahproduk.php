...
<form method="post" enctype="multipart/form-data">
	...
	<div class="row">
		<div class="input-field col s6">
			...
			<input type="number" name="harga" value="<?= $pecah['harga_produk']; ?>" class="validate" required>
		</div>
		<div class="input-field col s6">
			<i class="material-icons prefix">gavel</i>
			<label>Berat (Gr)</label>
			<input type="number" name="berat" value="<?= $pecah['berat_produk']; ?>" class="validate" required>
		</div>
	</div>
	<div class="row">
	...
	<div class="row">
		<div class="input-field col s6">
			<img src="../foto_produk/<?= $pecah['foto_produk']  ?>" width="200" required>
		</div>
	</div>
	<div class="row">
