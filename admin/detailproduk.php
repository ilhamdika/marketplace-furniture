 ...
 <div class="row">
 	<div class="col s4 ">
 		<a href="index.php?halaman=produk" class="btn blue waves-effect waves-dark">kembali</a>
 		<a href="index.php?halaman=hapusproduk&id=<?php echo $detailproduk['id_produk']; ?>" class="btn red waves-effect waves-dark">hapus</a>
 	</div>
