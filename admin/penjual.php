    ...
    <?php if ((isset($_POST['keyword']))) : ?>
      ...
      ?>
        <tr>
          ...
          <td>
            <a href="index.php?halaman=detailpenjual&id=<?php echo $row['id_toko']; ?>" class="btn cyan waves-effect waves-light" style="border-radius: 50px;">detail</a>
            <a href="index.php?halaman=hapuspenjual&id=<?php echo $row['id_toko']; ?>" class="btn red waves-effect waves-light" style="border-radius: 50px;">hapus</a>
          </td>
        </tr>
        <?php $nomor++ ?>
      <?php } ?>
