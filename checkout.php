 ...
 <head>
 	...
 	<title>Checkout | Jepara Furniture Community</title>
 </head>
 						...
 						<div class="row">
							...
							<div class="col s12 m3">
 							...
 							<div class="input-field col s12">
 								...
 								<textarea name="alamat_pengiriman" id="alamat_pengiriman" required cols="30" rows="10" class="materialize-textarea"></textarea><label for="alamat_pengiriman"> Detail Alamat (Provinsi, Kota, Kecamatan, Desa, RT/RW,nama jalan, no, jl. dll)</label><br><br>
 							</div>
 							<br> <br> <br>
 							<!-- <div class="row">
 							...
 							<div class="row">
 								<div class="col s12 m3">
 									...
 									<input type="text" placeholder="Harga Ongkir" name="ongkir">
 								</div>
 								<!-- <div class="col s12 m3">
 								...
 								<br>
 								<div class="col s12 m3">
 									<button class="btn btn-primary" name="checkout" style="border-radius:50px;">Buat Pesanan</button>
 								</div>
 							</div>
 				</form>
