...
<head>
	...
	<title>Daftar Penjual | Jepara Furniture Community </title>
</head>
	...
	?>
		<div class="container">
			<h3 text-center>Daftar sebagai Penjual</h1>
				<h5 text-center>Lihat Status Toko & update profil toko Anda
			</h3>
			<form action="" method="post" enctype="multipart/form-data">
				<div class="row">
					...
					<div class="input-field col s4">
						...
						<label for="telepon_toko">Nomor whatsapp</label>
					...
					<div class="col s6 m3">
						<label for="nama_distrik">Kabupaten</label>
				...
				<button class="btn waves-effect waves-light right" name="simpan" style="border-radius: 50px;">simpan
