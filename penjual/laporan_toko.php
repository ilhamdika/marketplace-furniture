...
<?php if (isset($_POST['kirim'])) : ?>
	<h2 class="text-center" style="color:black ;">Laporan Penjualan <br> <?= date("d F Y", strtotime($tgl_mulai)) ?> - <?= date("d F Y", strtotime($tgl_selesai)) ?></h2> <br> <br> <br>
<?php else : ?>
	<h2 class="text-center">Laporan Penjualan</h2> <br> <br> <br>
<?php endif; ?>
<form method="post">
	<div class="row">
		<div class="col s12">
			<div class="row">
				...
				<br>
				<button class="btn waves-effect waves-light col s2" name="kirim" style="border-radius: 50px ;">LIHAT LAPORAN</button>
			</div>
		</div>
	</div>
</form>
...
<?php if (isset($_POST['kirim'])) : ?>
	<a href="download_laporan.php?tglm=<?php echo $tgl_mulai ?>&tgls=<?php echo $tgl_selesai ?>&status=<?php echo $status ?>&id=<?php echo $id_toko ?>" target="_blank">Download PDF</a>
<?php endif; ?>
