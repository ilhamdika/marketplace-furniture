...
<h2 class="text-center" style="color: black;"> Data Pembayaran</h2>
...
<div class="row">
	<form method="post">
		...
		<?php else : ?>
			...
			<br>
			<button class="btn green waves-effect waves-dark col s1" name="proses" style="border-radius: 50px;">Proses</button> &nbsp;
		<?php endif; ?>
