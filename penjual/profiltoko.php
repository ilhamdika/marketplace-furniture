 ...
 <h2 class="center" style="color:black ;">Toko</h2>
 ...
 <div class="row">
 	...
 	<div class="col s3" style="margin-top: 10px; position: relative;">
 		<span class="white-text">
 			<h6 style="color:black ;"><b><?php echo $pecah['nama_toko']; ?></b></h6>
 			<h6 style="color:black ;"><?php echo 	$pecah['alamat_toko'] ?></h6>
 		</span>
 	</div>
 	<div class="col s1">
 		<p>
 				...
 				<div class=" responisve-card card hoverable" style="border-radius:30px; background-color: #d3d3d3 ;">
 					...
 					<div class="card-content">
 						...
 						<div class="card-action">
 							<a href="index.php?halaman=detail&id=<?php echo $perproduk['id_produk']; ?>" class="btn waves-effect waves-light red btn-small ">detail</a>
