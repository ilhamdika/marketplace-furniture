  ...
  <h2 class="text-center" style="font-size: 40px; color: black; font-style: oblique;">Selamat Datang <br> <?php echo $pecah['nama_toko']; ?></h2>
  <br> <br> <br>
  <?php
  ...
  <div class="row">
          ...
          <div class="card horizontal teal hoverable">
              ...
              <div class="card-stacked">
                  <div class="col s8 offset-s4">
                      <h3 class="content-card right"><b><?php if ($produk < 1) : ?>
                                  <?php echo  "-" ?>
                              <?php else : ?>
                                  <?php echo  $produk; ?>
                              <?php endif; ?></b></h3>
      ...
      <div class="col s12 m6 l3 ">
          <div class="card horizontal teal hoverable">
              ...
              <div class="card-stacked">
                  <div class="col s8 offset-s4">
                      <h3 class="content-card right"><b><?php if ($stok_produk < 1) : ?>
                                  <?php echo   "-" ?>
                              <?php else : ?>
      ...
      <div class="col s12 m6 l3 ">
          <div class="card horizontal teal hoverable">
              ...
              <div class="card-stacked">
                  <div class="col s8 offset-s4">
                      <h3 class="content-card right"><b><?php if ($produk_terjual < 1) : ?>
                                  <?php echo  "-" ?>
                              <?php else : ?>
