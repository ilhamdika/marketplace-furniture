...
<div id="wrapper">
	<nav class="navbar navbar-cls-top " style="margin-bottom: 0; background-color: white; ">
		<a href="#" data-target="slide-out" class="sidenav-trigger show-on-large"><i class="material-icons" style="color:black;">menu</i></a>
		<div class="container">
			<a href="../index.php" class="brand-logo center"><img src="../assets/img/homepage/logo2.png" height="50" width="100" class="logo"></a>
			<ul id="nav-mobile" class="right hide-on-med-and-down">
				...
				<?php if (isset($_SESSION['penjual'])) : ?>
					<li>
						<a class="nav-link" href="../logout.php" tabindex="-1" aria-disabled="true" style="color:black">Logout</a>
					</li>
	...
	<ul id="slide-out" class="sidenav">
		<li class="text-center">
			...
			<?php while ($pecah = $ambil->fetch_assoc()) { ?>
				<img src="../assets/img/toko/<?= $pecah['foto_toko'] 	 ?> " style="border-radius:100px;" class="user-image img-responsive" />
