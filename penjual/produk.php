...
?>
<h2 class="text-center" style="color: black;">Data Produk <br><?php echo $pecah['nama_toko'] ?></h2>
<br><br><br>
<div class="row">
	<form action="" method="post" autocomplete="off">
		<div class="col s2">
			<br>
			<a href="index.php?halaman=tambahproduk" class="btn green waves-effect waves-dark " style="border-radius: 50px;">Tambah Produk</a>
		</div>
		<div class="col s8">
			<div class="input-field">
				<i class="material-icons prefix">search</i>
				<input name="keyword" placeholder="Cari Data Produk" autofocus>
			</div>
		</div>
		<div class="col s2"><br>
			<button type="submit" name="cari" class="btn teal" style="border-radius: 50px;">Cari</button>
		</div>
	</form>
</div>
<br>
<table class='table striped centered' align="center">
	...
	<tbody align="center">
		...
		AND nama_toko LIKE '%$keyword%' 
		OR produk.id_toko = '$id_toko'
		AND nama_produk LIKE '%$keyword%'
		OR produk.id_toko = '$id_toko'
		AND nama_kategori LIKE '%$keyword%'  
		ORDER BY id_produk
      LIMIT " . $limitStart . "," . $limit);
			...
			?>
				<tr>
					...
					<td>
						<a href="index.php?halaman=hapusproduk&id=<?php echo $row['id_produk']; ?>" class="btn red waves-effect waves-light" style="border-radius: 50px;">hapus</a>
						<a href="index.php?halaman=ubahproduk&id=<?php echo $row['id_produk']; ?>" class="btn orange waves-effect waves-light" style="border-radius: 50px;">ubah</a>
						<a href="index.php?halaman=detailproduk&id=<?php echo $row['id_produk']; ?>" class="btn cyan waves-effect waves-light" style="border-radius: 50px;">detail</a>
					</td>
				</tr>
				<?php $nomor++; ?>
			<?php } ?>
