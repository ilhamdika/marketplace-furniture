...
<h2 style="color: black;">
  <center>Data Penjualan Produk <br> <?= $pecah['nama_toko'];  ?></center>
</h2>
<br>
<div class="row">
...
<table class="table striped centered">
  ...
  <tbody>
    <?php if ((isset($_POST['keyword']))) : ?>
      ...
      AND nama_pelanggan LIKE '%$keyword%'
      OR pembelian.id_toko='$id_toko' 
      AND status_pengiriman  LIKE '%$keyword%'
      OR pembelian.id_toko='$id_toko' 
      ...
      ?>
        <tr>
          ...
          <td><?php echo $row["tipe"] ?> <?php echo  $row["distrik"]; ?></td>
          ...
          <td>
            <a href="index.php?halaman=detail&id=<?php echo $row['id_pembelian']; ?>" class="btn cyan">detail</a>
            <?php if ($row['id_pengiriman'] > 0) : ?>
              <a href="index.php?halaman=pembayaran&id=<?php echo $row['id_pembelian'] ?>"> <button class="btn amber" style="border-radius: 50px;">pembayaran</button></a>
            <?php endif ?>
          </td>
        </tr>
        <?php $nomor++; ?>
    ...
    ORDER BY id_pembelian
      ...
      ?>
        <tr>
          ...
          <td>Rp.<?php echo number_format($row['total_pembelian']); ?></td>
          <td>
            <a href="index.php?halaman=detail_penjualan&id=<?php echo $row['id_pembelian']; ?>" class="btn cyan" style="border-radius: 50px;">detail</a>
            <?php if ($row['id_pengiriman'] > 0) : ?>
              <a href="index.php?halaman=pembayaran&id=<?php echo $row['id_pembelian'] ?>"> <button class="btn amber" style="border-radius: 50px;">pembayaran</button></a>
            <?php endif ?>
          </td>
...
<div align="right">
  <ul class="pagination">
    ...
    ?>
      ...
      <!-- link Previous Page -->
      <li class="active"><a href="index.php?halaman=data_penjualan&page=<?php echo $LinkPrev; ?>"><i class="material-icons">chevron_left</i></a></li>
    <?php }  ?>
    ...
    ?>
      <li class="waves-effect"><?php echo $linkActive; ?><a href="index.php?halaman=data_penjualan&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
    <?php
    }
    ?>
    ...
    ?>
      <li><a href="index.php?halaman=data_penjualan&page=<?php echo $linkNext; ?>"><i class="material-icons">chevron_right</i></a></li>
    <?php
    }
    ?>
  </ul>
