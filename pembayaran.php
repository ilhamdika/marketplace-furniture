      ...
      ?>
        ...
        <div class="row">
          <form method="post" enctype="multipart/form-data">
            ...
            <div class="input-field col s12">
              <i class="material-icons prefix"><img src="https://upload.wikimedia.org/wikipedia/commons/4/4e/Indonesian_rupiah_icon.png" style="max-width: 30px;"></i>
            ...
            <div class="col s2">
              <br>
              <button class="btn waves-effect waves-light right" name="kirim" style="border-radius: 50px;">Kirim
        ...
        <div class="col s2">
          <a href="riwayat.php" class="btn red" style="border-radius: 50px;">Kembali</a>
        </div> <br> <br> <br> <br>
        <?php
